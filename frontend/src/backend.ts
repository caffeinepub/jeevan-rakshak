...
import type { ExternalBlob as _ExternalBlob, MedicalProfile as _MedicalProfile, Medicine as _Medicine, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getCallerUserProfile(): Promise<MedicalProfile | null> {
        if (this.processError) {
            try {
    ...
    async getUserMedications(arg0: Principal): Promise<Array<Medicine>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserMedications(arg0);
    ...
    async getUserProfile(arg0: Principal): Promise<MedicalProfile | null> {
        if (this.processError) {
            try {
    ...
    async recordSymptomSession(arg0: Array<string>, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordSymptomSession(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveCallerUserProfile(arg0: MedicalProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveCallerUserProfile(await to_candid_MedicalProfile_n20(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_MedicalProfile_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MedicalProfile): Promise<MedicalProfile> {
    return await from_candid_record_n12(_uploadFile, _downloadFile, value);
}
async function from_candid_Medicine_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Medicine): Promise<Medicine> {
...
async function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MedicalProfile]): Promise<MedicalProfile | null> {
    return value.length === 0 ? null : await from_candid_MedicalProfile_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        medicines: await from_candid_vec_n15(_uploadFile, _downloadFile, value.medicines),
...
async function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Medicine>): Promise<Array<Medicine>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Medicine_n16(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_MedicalProfile_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MedicalProfile): Promise<_MedicalProfile> {
    return await to_candid_record_n21(_uploadFile, _downloadFile, value);
}
async function to_candid_Medicine_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Medicine): Promise<_Medicine> {
...
async function to_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        emergencyContact: value.emergencyContact,
        chronicConditions: value.chronicConditions,
        photo: value.photo ? candid_some(await to_candid_ExternalBlob_n22(_uploadFile, _downloadFile, value.photo)) : candid_none(),
        medicines: await to_candid_vec_n23(_uploadFile, _downloadFile, value.medicines),
        allergies: value.allergies
    };
}
...
async function to_candid_vec_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<Medicine>): Promise<Array<_Medicine>> {
    return await Promise.all(value.map(async (x)=>await to_candid_Medicine_n24(_uploadFile, _downloadFile, x)));
}
